...
<body class="g-sidenav-show bg-gray-800">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="{{ route('tablebook') }}">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ route('tablenotification') }}">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                  <title>shop </title>
                  <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <li class="nav-item">
            <li class="nav-item">
                <a class="nav-link" href="{{ route('tableloan') }}">
                  <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                      <title>shop </title>
                      <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
              ...
              <li class="nav-item">
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('tablelog') }}">
                      <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                          <title>shop </title>
                          <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      ...
      <div id="tablesiswa">
        ...
        <div class="card mb-4 bg-gray-200">
            <div class="card-header pb-0 bg-gray-300">
                <h5 style="color: white">Books Data</h6>
                <div class="d-flex justify-content-between align-items-center">
                  <h6 style="color: white">Books Type</h6>
                    <button type="button" class="btn bg-gradient-info w-20" data-bs-toggle="modal" onclick="createCategory()">
                      + Add Category 
                  </button>
              </div>
              <div class="mb-4">
                <select class="form-control" id="bookType" name="bookType" onchange="toggleTable()">
  ...
  <script>
    ...
    function saveCreatedBook() {
        ...
        var stock = document.getElementById("createStock").value;
        var page = document.getElementById("createPage").value;
        var language = document.getElementById("createLanguage").value;
        var rate = document.getElementById("createRate").value;
        var sinopsis = document.getElementById("createSynopsis").value;
        ...
        if (file) {
          formData.append("book_file", file); // Append PDF file only if a file is selected
        }
    ...
    function editBook(id) {
        ...
        var stock = row.cells[6].innerHTML;
        var page = row.cells[7].innerHTML;
        var rate = row.cells[8].innerHTML;
        var language = row.cells[9].innerHTML;
        var sinopsis = row.cells[10].innerHTML;
        ...
        document.getElementById("editBookPage").value = page;
        document.getElementById("editBookRate").value = rate;
        document.getElementById("editBookLanguage").value = language;
        document.getElementById("editBookSynopsis").value = sinopsis;

        var type = document.getElementById('editBookType').value;
            var stockField = document.getElementById('stockEditField');
            var fileField = document.getElementById('fileEditField');
    ...
    function saveEditedBook() {
      var formElement = document.getElementById('editBookForm');
      var formData = new FormData(formElement);

      formData.append('id', $('#editBookId').val());
      formData.append('title', $('#editBookTitle').val());
      formData.append('writer', $('#editBookWriter').val());
      formData.append('publisher', $('#editBookPublisher').val());
      formData.append('category', $('#editBookCategory').val());
      formData.append('type', $('#editBookType').val());
      formData.append('stock', $('#editBookStock').val());
      formData.append('rate', $('#editBookRate').val());
      formData.append('page', $('#editBookPage').val());
      formData.append('language', $('#editBookLanguage').val());
      formData.append('sinopsis', $('#editBookSynopsis').val());

      var bookPicture = $('#editBookCover')[0].files[0];
      var bookFile = $('#editBookFile')[0].files[0];
      ...
      Swal.fire({
          ...
          if (result.isConfirmed) {
              $.ajax({
                  type: 'POST',
                  url: '/update-book', // URL to your Laravel controller method
                  data: formData,
                  contentType: false,
                  processData: false,
                  headers: {
                      ...
                      if (response.success) {
                          ...
                          Swal.fire({
                              ...
                              if (result.isConfirmed) {
                                  ...
                                  var row = document.getElementById("book_" + book.id);
                                  row.cells[1].innerHTML = book.title;
                                  row.cells[2].innerHTML = book.writer;
                                  row.cells[3].innerHTML = book.publisher;
                                  row.cells[4].innerHTML = book.category;
                                  row.cells[5].innerHTML = book.type;
                                  row.cells[6].innerHTML = book.stock;
                                  row.cells[7].innerHTML = book.page;
                                  row.cells[8].innerHTML = book.rate;
                                  row.cells[9].innerHTML = book.language;
                                  row.cells[10].innerHTML = book.sinopsis;
                                  row.cells[0].querySelector('img').src = book.book_picture ? `/storage/${book.book_picture}` : 'default-book-cover.jpg';
                                  row.cells[11].innerHTML = book.book_file
                                      ? `<p onclick="showPDF('/storage/${book.book_file}')" style="cursor: pointer">View PDF</p>`
                                      : 'No file';
                              }
                          });
                      } else {
    ...
    function saveDeleteBook(bookId) {
      Swal.fire({
        title: "Are you sure?",
    ...
    function saveCreatedCategory() {
        var category = document.getElementById("createdCategory").value;
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: 'POST',
                    url: '/create-category', // Assuming your route is /create
                    data: formData, // Send FormData instead of an object
                    contentType: false, // Set contentType to false
                    processData: false, // Set processData to false
                    headers: {
    ...
    function saveDeleteCategory(categoryId) {
      Swal.fire({
        title: "Are you sure?",
        text: "You won't be able to revert this!",
        icon: "warning",
    ...
    function toggleTable() {
        ...
        var offline = document.getElementById('tableOffline');
        var online = document.getElementById('tableOnline');
