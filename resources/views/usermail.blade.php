                    ...
                    <div class="item">
                        <div class="thumb" style="margin-top:10%">
                            ...
                            <ul class="list-group">
                                ...
                                <li class="list-group-item" style="background-color: #343a40; margin: 1%">
                                    <p>{{ $mail->created_at }}</p>
                                    <p>Admin - Modern Library</p>
                                    <h4 style="color: white">{{ $mail->status }}</h4>
                                    <p style="color: white">{{ $mail->header }}</p>
                                    <!-- Modify the link to point to the new page with the mail ID as a query parameter -->
                                    <p><a href="{{ route('mail.detail', ['mailId' => $mail->id]) }}" class="text-white"><span style="color: rgb(61, 61, 255)">Click </span>for more details</a></p>
                                </li>
                                @endforeach
                            </ul>
                            @if(count($mails) === 0)
