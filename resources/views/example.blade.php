...
<body class="g-sidenav-show bg-gray-800">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
    ...
    <div class="container-fluid py-4">
      <div id="tablesiswa">
        <button type="button" class="btn bg-gradient-success w-100" data-bs-toggle="modal" onclick="createStudent()">
            + Add Student
        </button>
        
        <div class="card mb-4 bg-gray-200">
            <div class="card-header pb-0 bg-gray-300">
                <h6 style="color: white">Students Data</h6>
            </div>
                    ...
                    <table class="table align-items-center mb-0" id="tablesiswa">
                        ...
                        <tbody>
                            ...
                            <tr id="student_{{ $student->id }}">
                                ...
                                <td>{{ $student->email }}</td>
                                <td>
                                    <button type="button" class="btn bg-gradient-info w-30 mt-0 mb-0" onclick="editStudent('{{ $student->id }}')">Edit</button>
                                    <button type="button" class="btn bg-gradient-danger w-30 mt-0 mb-0" onclick="saveDeleteStudent('{{ $student->id }}')" data-student-id="{{ $student->id }}">Delete</button>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
  ...
  <script>
    ...
    function saveEditedStudent() {
        ...
        var email = $('#editStudentEmail').val(); // Serialize form data
