                ...
                <div class="col-12">
                    <nav class="main-nav d-flex align-items-center justify-content-between">
                        ...
                        <ul class="nav d-flex align-items-center justify-content-center" style="flex-grow: 1; margin-bottom: 0;">
                            ...
                            <li><a href="{{ route('userlog') }}"  class="active">History</a></li>
                        ...
                        <div class="thumb" style="margin-top:10%">
                          ...
                          <div class="row">
                            <div class="col-lg-12">
                                <div class="row">
                                  @foreach($logs as $log)
                                    @if($log->book) <!-- Check if the loan has a related book -->
                                        <div class="col-sm-4 col-md-4 col-lg-2 m-5">
                                            <div class="item">
                                                    <div class="card" style="width: 250px; height: 370px;">
                                                        <img src="{{ $log->book->book_picture ? asset('storage/' . $log->book->book_picture) : asset('default-book-cover.jpg') }}" class="card-img" style="width: 100%; height: 80%;">
                                                        <div class="card-body">
                                                            <h1 class="card-title">{{ $log->title }}</h1>
                                                            <p class="card-text">
                                                                {{ $log->category }}
                                                            </p>
