        ...
        <li class="nav-item">
          ...
          <li class="nav-item">
            <li class="nav-item">
              ...
              <li class="nav-item">
                <li class="nav-item">
                    <a class="nav-link active" href="{{ route('tablelog') }}">
                      <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                          <title>shop </title>
                          <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <table class="table align-items-center mb-0" id="tablesiswa">
                        <thead>
                            <tr>
                                ...
                                <th class="text-uppercase text-white text-xxs font-weight-bolder">Request Date</th>
                                ...
                                <th class="text-uppercase text-white text-xxs font-weight-bolder">Book Condition</th>
                                <th class="text-uppercase text-white text-xxs font-weight-bolder">Notes</th>
                                <th class="text-uppercase text-white text-xxs font-weight-bolder">Log</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach($logs as $log)
