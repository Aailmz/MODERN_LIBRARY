...
<body class="g-sidenav-show bg-gray-800">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link active" href="{{ route('tablepetugas') }}">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{ route('adminsiswa') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
    ...
    <div class="container-fluid py-4">
      <div id="tablesiswa">
        <button type="button" class="btn bg-gradient-success w-100" data-bs-toggle="modal" onclick="createEmployee()">
            + Add Employee
        </button>
        <div class="card mb-4 bg-gray-200">
            <div class="card-header pb-0 bg-gray-300">
                <h6 style="color: white">Employees Data</h6>
            </div>
                    ...
                    <table class="table align-items-center mb-0" id="tablesiswa">
                        ...
                        <tbody>
                            ...
                            <tr id="employee_{{ $employee->id }}">
                                ...
                                <td>
                                  <button type="button" class="btn bg-gradient-info w-30 mt-0 mb-0" onclick="editEmployee('{{ $employee->id }}')">Edit</button>
                                    <button type="button" class="btn bg-gradient-danger w-30 mt-0 mb-0" onclick="saveDeleteEmployee('{{ $employee->id }}')">Delete</button>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
  ...
  <script>
    ...
    function saveCreatedEmployee() {
        var name = document.getElementById("createEmployeeName").value;
        var email = document.getElementById("createEmployeeEmail").value;
        var password = document.getElementById("createEmployeePassword").value;
    ...
    function editEmployee(id) {
        var row = document.getElementById("employee_" + id);
    ...
    function saveEditedEmployee() {
        ...
        var email = $('#editEmployeeEmail').val(); // Serialize form data
        var password = $('#editEmployeePassword').val();
        formData += '&id=' + id;
        formData += '&name=' + name;
    ...
    function saveDeleteEmployee(employeeId) {
      Swal.fire({
        title: "Are you sure?",
